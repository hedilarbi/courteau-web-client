...
const page = () => {
  return (
    <main className="md:px-14 md:py-10 p-4 ">
      ...
      <div className="">
        <h2 className="md:text-2xl text-lg font-bold mb-2 font-inter">
        ...
        <p className="md:text-base/7 text-sm font-inter text-gray-700 font-semibold">
          ...
          fait référence à Casse-croûte Courteau, le programme logiciel fourni
          par la Société.
        </p>
        <p className="md:text-base/7 text-sm font-inter text-gray-700 font-semibold">
          <span className="font-bold text-black md:text-base text-sm">
          ...
          (dénommée « la Société », « Nous », « Notre » ou « Nos » dans le
          présent accord) désigne Casse-croûte Courteau, 3331 Rue des Prairies,
          Trois-Rivières, QC G8V 1W7, Canada.
        </p>
        <p className="md:text-base/7 text-sm font-inter text-gray-700 font-semibold">
          <span className="font-bold text-black md:text-base text-sm">
            Pays
          </span>{" "}
          fait référence à : Québec, Canada
        </p>
        <p className="md:text-base/7 text-sm font-inter text-gray-700 font-semibold">
          <span className="font-bold text-black md:text-base text-sm">
            Dispositif
        ...
        <p className="md:text-base/7 text-sm font-inter text-gray-700 font-semibold">
          ...
          désigne toute information se rapportant à une personne identifiée ou
          identifiable.
        </p>
        <p className="md:text-base/7 text-sm font-inter text-gray-700 font-semibold">
          <span className="font-bold text-black md:text-base text-sm">
        ...
        <p className="md:text-base/7 text-sm font-inter text-gray-700 font-semibold">
          ...
          désigne toute personne physique ou morale qui traite les données pour
          le compte de la Société. Il fait référence à des sociétés tierces ou à
          des personnes employées par la Société pour faciliter le service,
          fournir le service au nom de la Société, effectuer des services liés
          au service ou aider la Société à analyser la manière dont le service
          est utilisé.
        </p>
        <p className="md:text-base/7 text-sm font-inter text-gray-700 font-semibold">
          <span className="font-bold text-black md:text-base text-sm">
            Service de médias sociaux tiers{" "}
          </span>
          fait référence à tout site Web ou site de réseau social par le biais
          duquel un utilisateur peut se connecter ou créer un compte pour
          utiliser le service.
        </p>
        <p className="md:text-base/7 text-sm font-inter text-gray-700 font-semibold">
          <span className="font-bold text-black md:text-base text-sm">
        ...
        <p className="md:text-base/7 text-sm font-inter text-gray-700 font-semibold ">
          ...
          informations personnelles identifiables peuvent inclure, mais ne sont
          pas limitées à :<br /> Adresse e-mail
          <br /> Prénom et nom de famille
          <br /> Numéro de téléphone <br /> Adresse, État, Province, Code
          postal, Ville <br />
        </p>
        <h3 className="md:text-xl text-base font-bold mb-2 font-inter mt-2">
          Données d&quot;utilisation
        ...
        <p className="md:text-base/7 text-sm font-inter text-gray-700 font-semibold ">
          ...
          utiliser le service via les services de médias sociaux tiers suivants
          :<br /> Google <br />
          Facebook <br /> Instagram <br />
          Twitter
          <br /> LinkedIn
        ...
        <p className="md:text-base/7 text-sm font-inter text-gray-700 font-semibold ">
          ...
          nous pouvons divulguer vos informations personnelles à toute autre fin
          avec votre consentement.
        </p>
        <h3 className="md:text-xl text-base font-bold mb-2 font-inter mt-2">
        ...
        <p className="md:text-base/7 text-sm font-inter text-gray-700 font-semibold ">
          La société conservera vos données personnelles uniquement pendant la
        ...
        <p className="md:text-base/7 text-sm font-inter text-gray-700 font-semibold ">
          ...
          données peuvent différer de celles de votre juridiction. Votre
          consentement à la présente politique de confidentialité, suivi de
          votre soumission de telles informations, représente votre accord à ce
        ...
        <p className="md:text-base/7 text-sm font-inter text-gray-700 font-semibold ">
          ...
          sujet. Notre service peut vous donner la possibilité de supprimer
          certaines informations vous concernant depuis le service. Vous pouvez
          mettre à jour, modifier ou supprimer vos informations à tout moment en
        ...
        <p className="md:text-base/7 text-sm font-inter text-gray-700 font-semibold ">
          ...
          vos données personnelles si elle est tenue de le faire par la loi ou
          en réponse à des demandes valides des autorités publiques (par
        ...
        <p className="md:text-base/7 text-sm font-inter text-gray-700 font-semibold ">
          ...
          de bonne croyance que cette action est nécessaire pour :<br /> Se
          conformer à une obligation légale
          <br /> Protéger et défendre les droits ou les biens de la Société
          <br /> Prévenir ou enquêter sur des actes répréhensibles éventuels en
          relation avec le Service
          <br /> Protéger la sécurité personnelle des utilisateurs du Service ou
          du public
          <br /> Se protéger contre une responsabilité légale
        </p>
        <h3 className="md:text-xl text-base font-bold mb-2 font-inter mt-2">
        ...
        <p className="md:text-base/7 text-sm font-inter text-gray-700 font-semibold ">
          ...
          informerons également par e-mail et/ou par un avis bien visible sur
        ...
        <p className="md:text-base/7 text-sm font-inter text-gray-700 font-semibold ">
          ...
          confidentialité, vous pouvez nous contacter :<br /> Par numéro de
          téléphone : +1 819-371-3935
        </p>
      </div>
    </main>
  );
